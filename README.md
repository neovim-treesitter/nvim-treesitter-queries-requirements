# nvim-treesitter-queries-requirements

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-requirements/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-requirements/actions/workflows/validate.yml)

Neovim tree-sitter queries for **requirements**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-requirements",
...
- [ ] Changes are scoped to `requirements` — do not include files for other languages
